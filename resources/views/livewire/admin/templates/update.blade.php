<div class="content-wrapper">
    <div class="row">
        <div class="col-xl-6 grid-margin stretch-card flex-column">
            <h5 class="mb-2 text-titlecase mb-2">Update Template</h5>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 ">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input wire:model='master_image' type="file" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div style="position: absolute; width: {{$master_layout['width']}}mm; height: {{$master_layout['height']}}mm; border: 1px solid #ccc;">
                                            ...
                                            @if ($master_saved_image)
                                            <img style="width:100%; height:100%;" src="{{asset($master_saved_image)}}">
                                            @endif
